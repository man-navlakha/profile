            ...
            <section  className="relative py-10 px-6 md:py-24" id="Skills">
                <div className="px-4 md:px-8">
                    <div className="flex flex-col items-center mb-20">
                        ...
                        {/* <div className="-z-1 absolute mt-20 md:top-24">
                            <svg
                    ...
                    <div className="flex flex-col z-5 gap-20">
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                {[
                                   ...
                                   "Tailwind CSS", "DOM", "WordPress"
                                    ...
                                    <button key={skill} className="border border-gray-600 bg-gray-100 lg:p-4 py-1 px-2 rounded-md text-center hover:bg-gray-800 hover:text-white cursor-pointer">
                                        {skill}
                                    </button>
                                ))}
                            </div>
